...
class PatternConfigScreen(private val parent: Screen?) : Screen(Component.literal("Veinminer Patterns")) {
    ...
    override fun init() {
        ...
        patternList = PatternList(minecraft!!, panelWidth(), height, panelTop(), panelBottom(), ROW_HEIGHT)
        patternList.setLeftPos(panelLeft())
        patternList.scrollAmount = patternListScrollAmount
        ...
        addRenderableWidget(
            Button.builder(Component.literal("HELP").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(cGold)))) {
    ...
    private fun rebuildPatternWidgets() {
        if (::patternList.isInitialized) patternListScrollAmount = patternList.scrollAmount
        rebuildWidgets()
    }
    ...
    private inner class PatternList(
        ...
        y1: Int,
        itemHeight: Int,
    ) : ContainerObjectSelectionList<PatternEntry>(minecraft, width, height, y0, y1, itemHeight) {
        init {
        ...
        override fun getScrollbarPosition(): Int = panelLeft() + width - 10
    }
...
private class PatternIconButton(
    ...
    override fun renderWidget(graphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        graphics.blit(pattern.icon(), x + 2, y + 2, 0f, 0f, width - 4, height - 4, 16, 16)
...
private class MoveSpriteButton(
    ...
    override fun renderWidget(graphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        val tint = if (active) 1f else 0.5f
        graphics.setColor(tint, tint, tint, 1f)
        graphics.blit(texture, x, y, 0f, 0f, width, height, 16, 16)
        graphics.setColor(1f, 1f, 1f, 1f)
    }
    ...
    private companion object {
        val MOVE_UP_SPRITE: ResourceLocation = ResourceLocation(ClientLifecycle.MOD_ID, "textures/gui/sprites/menu/move_up.png")
        val MOVE_UP_HIGHLIGHTED_SPRITE: ResourceLocation = ResourceLocation(ClientLifecycle.MOD_ID, "textures/gui/sprites/menu/move_up_highlighted.png")
        val MOVE_DOWN_SPRITE: ResourceLocation = ResourceLocation(ClientLifecycle.MOD_ID, "textures/gui/sprites/menu/move_down.png")
        val MOVE_DOWN_HIGHLIGHTED_SPRITE: ResourceLocation = ResourceLocation(ClientLifecycle.MOD_ID, "textures/gui/sprites/menu/move_down_highlighted.png")
        val DELETE_SPRITE: ResourceLocation = ResourceLocation(ClientLifecycle.MOD_ID, "textures/gui/sprites/menu/delete.png")
        val DELETE_HIGHLIGHTED_SPRITE: ResourceLocation = ResourceLocation(ClientLifecycle.MOD_ID, "textures/gui/sprites/menu/delete_highlighted.png")
    }
}
